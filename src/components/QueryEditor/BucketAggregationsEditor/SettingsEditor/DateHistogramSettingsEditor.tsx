...
import { Combobox, ComboboxOption, InlineField, Input, TimeZonePicker } from '@grafana/ui';
...
const defaultIntervalOptions: Array<ComboboxOption<string>> = [
...
export const DateHistogramSettingsEditor = ({ bucketAgg }: Props) => {
  ...
  return (
    <>
      ...
      >
        <Combobox
          id={uniqueId('es-date_histogram-interval')}
